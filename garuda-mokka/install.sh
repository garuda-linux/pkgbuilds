...
COLORDIR="${USR_DIR}/color-schemes"
AURORAEDIR="${USR_DIR}/aurorae/themes"
LOOKANDFEELDIR="${USR_DIR}/plasma/look-and-feel"
CURSORDIR="${USR_DIR}/icons"
